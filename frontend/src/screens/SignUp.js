...
const SignUp = () => {
    ...
    return (<div className="text-white flex flex-col w-screen h-screen bg-[#1F1D36]">
        <div className="w-screen h-[35%]">
            <div className="w-screen h-[100%] rotate-[-22deg] bg-fill" style={{ backgroundImage:  `url(${backg})` />
        </div>
        <div className="flex flex-col justify-around items-center h-[65%]">
            ...
            <form onSubmit={doSignUp} className="flex flex-col justify-evenly items-center w-screen h-[70%]">
                ...
                <div className="relative w-4/5 lg:w-1/4">
                    ...
                    <input required placeholder="Type your email" type="email" onChange={onChange} value={form.email} name="email" className="bg-stone-300 bg-opacity-30 border border-stone-300 border-opacity-30 text-white text-opacity-50 text-sm rounded-[30px] focus:ring-gray-500 focus:border-gray-500 block w-full pl-10 p-2.5" />
                </div>
                <div className="relative w-4/5 lg:w-1/4">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
